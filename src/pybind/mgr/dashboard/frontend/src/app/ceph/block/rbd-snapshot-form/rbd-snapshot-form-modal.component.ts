...
export class RbdSnapshotFormModalComponent extends BaseModal implements OnInit {
  ...
  get autoGeneratedSnapshotHint(): string {
    return this.isZhHans
      ? `映像 ${this.imageName} 已启用快照模式：快照名称将自动生成`
      : `Snapshot mode is enabled on image ${this.imageName}: snapshot names are auto generated`;
  }
